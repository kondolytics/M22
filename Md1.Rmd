...
ctrl <- trainControl(method = "repeatedcv", repeats = 5,
    ...
    set.seed(5627)
    down_inside <- train(Class ~ ., data = pitches_train,
                         method = "treebag",
                         nbagg = 10,
                         metric = "ROC",
                         trControl = ctrl)
    ...
    set.seed(5627)
    up_inside <- train(Class ~ ., data = pitches_train,
                       method = "treebag",
                       nbagg = 10,
                       metric = "ROC",
                       trControl = ctrl)
    ...
    set.seed(5627)
    rose_inside <- train(Class ~ ., data = pitches_train,
                         method = "treebag",
                         nbagg = 10,
                         metric = "ROC",
                         trControl = ctrl)
    ...
    set.seed(5627)
    smote_inside <- train(Class ~ ., data = pitches_train,
                          method = "treebag",
                          nbagg = 10,
                          metric = "ROC",
                          trControl = ctrl)
